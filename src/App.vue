...
<style scoped>
@reference "../../style.css"; /* O donde tengas tu archivo principal de Tailwind */

/* ESTRUCTURA BASE */
.main-container { min-height: 100vh; width: 100%; transition: background 0.8s ease; position: relative; overflow-x: hidden; }
...
.lang-group { display: flex; gap: 0.8rem; background: rgba(255,255,255,0.1); padding: 0.6rem 1.2rem; border-radius: 50px; backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.1); }
...
.theme-toggle { padding: 0.8rem 1.5rem; border-radius: 50px; font-weight: 800; cursor: pointer; border: 1px solid rgba(255,255,255,0.2); background: rgba(255,255,255,0.1); color: inherit; }

/* COLORES GLOBALES POR TEMA */
.pro { background: #0a0f1e; color: white; --accent-color: #4facfe; }
.creative { background: #fdfaf6; color: #2d2d2d; --accent-color: #ff4081; }
